...
class LlamaMLP(nn.Module):
    def __init__(self, config, layer_idx=None):
        ...
        self.gate_proj = quantLinear(self.hidden_size, self.intermediate_size, bias=config.mlp_bias, name=f'{layer_idx}.gate_proj')
        self.up_proj = quantLinear(self.hidden_size, self.intermediate_size, bias=config.mlp_bias, name=f'{layer_idx}.up_proj')
        self.down_proj = quantLinear(self.intermediate_size, self.hidden_size, bias=config.mlp_bias, name=f'{layer_idx}.down_proj')
...
class LlamaAttention(nn.Module):
    ...
    def __init__(self, config: LlamaConfig, layer_idx: Optional[int] = None):
        ...
        self.q_proj = quantLinear(self.hidden_size, self.num_heads * self.head_dim, bias=config.attention_bias, name=f'{layer_idx}.q_proj')
        self.k_proj = quantLinear(self.hidden_size, self.num_key_value_heads * self.head_dim, bias=config.attention_bias, name=f'{layer_idx}.k_proj')
        self.v_proj = quantLinear(self.hidden_size, self.num_key_value_heads * self.head_dim, bias=config.attention_bias, name=f'{layer_idx}.v_proj')
        self.o_proj = quantLinear(self.hidden_size, self.hidden_size, bias=config.attention_bias, name=f'{layer_idx}.o_proj')
