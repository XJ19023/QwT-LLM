...
class Qwen3DecoderLayer(GradientCheckpointingLayer):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        original_input = hidden_states # lbxj
...
class Qwen3Model(Qwen3PreTrainedModel):
    ...
    @can_return_tuple
    @auto_docstring
    def forward_before_blocks( # lbxj
        self,
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        with open('log/123_base.log', 'a') as f:
            f.writelines(f'>>>> Before Forward <<<<\n')
            f.writelines(f'hidden_states type: {type(hidden_states)} {hidden_states.shape}\n')
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        for layerID, decoder_layer in enumerate(self.layers[: self.config.num_hidden_layers]):
            ...
            with open('log/123_base.log', 'a') as f:
                ...
                f.writelines(f'hidden_states type: {type(hidden_states)} {hidden_states.shape}\n')
                f.writelines(f'attention_mask type: {type(causal_mask_mapping[decoder_layer.attention_type])} {causal_mask_mapping[decoder_layer.attention_type]}\n')
                f.writelines(f'position_ids type: {type(position_ids)} {position_ids}\n')
